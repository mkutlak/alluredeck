...
import (
	...
	"github.com/mkutlak/allure-docker-service/allure-docker-api/internal/handlers"
	"github.com/mkutlak/allure-docker-service/allure-docker-api/internal/middleware"
	...
	_ "github.com/mkutlak/allure-docker-service/allure-docker-api/internal/swagger"
)
...
func main() {
	...
	mux.Handle("/allure-docker-service/projects/", http.StripPrefix("/allure-docker-service/projects/", reportHandler))
	...
	registerRoutes(mux, "/allure-docker-service", cfg, jwtManager, systemHandler, authHandler, allureHandler)
...
// Having this helper ensures both the bare and /allure-docker-service prefixed
