    ...
    <div className="flex flex-wrap items-center gap-3">
      <div className="relative">
        ...
        <input
          ...
          className="border-input bg-background ring-offset-background placeholder:text-muted-foreground focus-visible:ring-ring h-9 rounded-md border py-1 pl-8 pr-3 text-sm focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2"
