  ...
  const css = Object.entries(THEMES)
    .map(([, prefix]) => {
      const vars = colorConfig
        .map(([key, itemConfig]) => {
          const color =
            itemConfig.theme?.[prefix as keyof typeof itemConfig.theme] || itemConfig.color
...
type ChartTooltipContentProps = React.ComponentProps<'div'> & {
  ...
  labelFormatter?: (label: unknown, payload: ReadonlyArray<ChartPayloadItem>) => React.ReactNode
  color?: string
