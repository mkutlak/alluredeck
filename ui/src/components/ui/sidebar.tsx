  ...
  (
    ...
    return (
      <div
        ...
        data-side={side}
      >
        {/* Spacer that animates the main content */}
        <div
          className={cn(
...
>(({ className, showIcon = false, ...props }, ref) => {
  // eslint-disable-next-line react-hooks/purity -- skeleton widths intentionally randomised; stable enough inside useMemo
...
export {
  ...
  SidebarSeparator,
  SidebarTrigger,
  // eslint-disable-next-line react-refresh/only-export-components -- shadcn pattern: hook co-located with sidebar components
  useSidebar,
}
