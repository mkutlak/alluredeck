...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/attachments/{id}": {
            "get": {
                "description": "Streams an attachment blob after verifying an HMAC-signed,\ntime-limited URL. The exp and sig query params are produced by\nthe MCP server when it hands out attachment resource links.",
                "produces": [
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/internal_handlers.ConfigResponse"
                        }
                    }
                }
            }
            ...
            "get": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "description": "Filter by parent (group) project ID",
                        "name": "group_id",
                        "in": "query"
                    }
                ],
        ...
        "/projects": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "boolean",
                        "description": "Return only top-level projects",
                        "name": "top_level",
                        "in": "query"
                    },
                    {
                        "type": "string",
                        "description": "Return children of this project ID",
                        "name": "parent_id",
                        "in": "query"
                    }
                ],
        ...
        "/projects/{project_id}": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Project ID (numeric) or slug",
                        "name": "project_id",
                        "in": "path",
                        "required": true
                    }
            ...
            "get": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        "type": "string",
                        "default": "duration",
                        "description": "Sort by: duration or failure_rate",
                        "name": "sort",
                        "in": "query"
                    },
                    {
        ...
        "/projects/{project_id}/branches/{branch_id}/default": {
            "put": {
        ...
        "/projects/{project_id}/builds/{build_id}/tests": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Build ID (primary key)",
                        "name": "build_id",
                        "in": "path",
                        "required": true
                    },
        ...
        "/projects/{project_id}/builds/{build_id}/tests/{history_id}/failure-summary": {
            "get": {
                "description": "Returns a cached or freshly generated LLM hypothesis about why\na test failed. Off by default; when disabled the body reports\nenabled:false. The summary is an AI hypothesis, not a verdict.",
                "produces": [
                    "application/json"
                ],
                "tags": [
                ...
                "parameters": [
                    ...
                    {
                        "type": "integer",
                        "description": "Build ID (surrogate PK)",
                        "name": "build_id",
                        "in": "path",
                        "required": true
                    },
        ...
        "/projects/{project_id}/compare": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "integer",
                        "description": "Build order A (baseline)",
                        "name": "a",
                        "in": "query",
                        "required": true
                    },
                    {
                        "type": "integer",
                        "description": "Build order B (target)",
                        "name": "b",
                        "in": "query",
                        "required": true
                    }
        ...
        "/projects/{project_id}/jobs/{job_id}": {
            "get": {
                "description": "Returns the current status of an async report generation job.\nIn addition to status/created_at/started_at/completed_at, the\nresponse includes an optional ` + "`" + `phase` + "`" + ` string (\"pending\",\n\"preparing_local\", \"generating_report\", \"publishing_report\",\n\"finalizing\", \"completed\", \"failed\") and an optional\n` + "`" + `progress` + "`" + ` object ` + "`" + `{done, total}` + "`" + ` for phases that report\nper-file progress (downloads and uploads). These fields are\nomitted when no progress has been published yet, so older\nclients ignoring unknown fields remain compatible.",
                "produces": [
                    "application/json"
                ],
                "tags": [
        ...
        "/projects/{project_id}/known-issues": {
            "get": {
        ...
        "/projects/{project_id}/known-issues/{issue_id}": {
            "put": {
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/internal_handlers.setParentRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/projects/{project_id}/pipeline-runs/{run_key}/failures": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Parent (group) project ID",
                        "name": "project_id",
                        "in": "path",
                        "required": true
                    },
                    {
                        "type": "string",
                        "description": "CI pipeline ID, or commit SHA when the pipeline ID is absent",
                        "name": "run_key",
                        "in": "path",
                        "required": true
                    },
        ...
        "/projects/{project_id}/playwright": {
            "post": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Parent project ID (used with force_project_creation)",
                        "name": "parent_id",
                        "in": "query"
                    },
                    {
        ...
        "/projects/{project_id}/reports": {
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Store results (true/1)",
                        "name": "store_results",
                        "in": "query"
                    },
                    {
        ...
        "/projects/{project_id}/reports/{report_id}/attachments": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Build order number or 'latest'",
                        "name": "report_id",
                        "in": "path",
                        "required": true
                    },
                    {
                        "type": "string",
                        "description": "MIME type prefix filter (e.g. 'image')",
                        "name": "mime_type",
                        "in": "query"
                    },
                    {
        ...
        "/projects/{project_id}/reports/{report_id}/attachments/{source}": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Attachment source filename",
                        "name": "source",
                        "in": "path",
                        "required": true
                    }
        ...
        "/projects/{project_id}/reports/{report_id}/categories": {
            "get": {
        ...
        "/projects/{project_id}/reports/{report_id}/environment": {
            "get": {
        ...
        "/projects/{project_id}/reports/{report_id}/known-failures": {
            "get": {
        ...
        "/projects/{project_id}/reports/{report_id}/stability": {
            "get": {
        ...
        "/projects/{project_id}/reports/{report_id}/summary": {
            "get": {
                "description": "Returns a JSON summary of a build including statistics, quality metrics,\ntop failures, and trend deltas compared to the previous build.",
                "produces": [
                    "application/json"
                ],
                "tags": [
        ...
        "/projects/{project_id}/reports/{report_id}/timeline": {
            "get": {
        ...
        "/projects/{project_id}/results": {
            "post": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "boolean",
                        "description": "Stream tar.gz to staging blob and return 202 immediately (only honored for application/gzip uploads)",
                        "name": "async",
                        "in": "query"
                    }
                ],
                "responses": {
                    ...
                    "202": {
                        "description": "Accepted (async=true): returns {job_id, batch_id} once the tar.gz is staged",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
        ...
        "/projects/{project_id}/test-history": {
            "get": {
        ...
        "/projects/{project_id}/timeline": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "End date (YYYY-MM-DD, inclusive end-of-day)",
                        "name": "to",
                        "in": "query"
                    },
                    {
                        "type": "integer",
                        "description": "Max builds (1-10, default 1)",
                        "name": "limit",
                        "in": "query"
                    }
                ],
        ...
        "/ready": {
            "get": {
                "description": "Probes each backing dependency (database, storage backend, job\nqueue) and returns 200 only when all wired dependencies are\nhealthy, 503 otherwise. The JSON body reports per-dependency\nstatus (\"ok\"/\"error\"/\"skipped\") so an operator can see which\ndependency is degraded. A nil (unwired) dependency is \"skipped\"\nand never fails readiness.",
                "produces": [
                    "application/json"
                ],
                "tags": [
        ...
        "/users": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Substring match on email or name",
                        "name": "search",
                        "in": "query"
                    },
                    {
    ...
    "definitions": {
        ...
        "internal_handlers.ConfigMetaData": {
            "type": "object",
            "properties": {
                "message": {
                    "type": "string"
        ...
        "internal_handlers.ConfigResponse": {
            "type": "object",
            "properties": {
                "data": {
                    "$ref": "#/definitions/internal_handlers.ConfigData"
                },
                "metadata": {
                    "$ref": "#/definitions/internal_handlers.ConfigMetaData"
                }
            }
        },
        ...
        "internal_handlers.VersionMetaData": {
            "type": "object",
            "properties": {
                "message": {
                    "type": "string"
        ...
        "internal_handlers.VersionResponse": {
            ...
            "properties": {
                "data": {
                    "$ref": "#/definitions/internal_handlers.VersionData"
                },
                "metadata": {
                    "$ref": "#/definitions/internal_handlers.VersionMetaData"
                }
            }
        },
        "internal_handlers.setParentRequest": {
            "type": "object",
            "properties": {
                "parent_id": {
                    "type": "integer"
